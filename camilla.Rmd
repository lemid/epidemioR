...
cinco estágios de crescimento de frutos. O experimento foi realizado em
condições controladas, utilizando frutos destacados. Cinco tamanhos de
frutos foram coletados do campo (tam1, tam2, tam3, tam4 e tam5). Os
frutos foram desinfestados e um ferimento foi provocado na região
equatorial das maças. Uma gota de suspensão de conídios do patógeno foi
depositada sobre o ferimento. Após a inoculação, os frutos foram
aleatoriamente distribuidos em uma sala de incubação com condições
...
fruto (\@ref(tab:conjuntodedados) sintomático ou a última data de
avaliação dos frutos sem sintomas. No caso de tabelas que contenham o
...
Para isso, consultar a próxima seção..
 ...
 * Comentar que a Weibull pode não ser o melhor modelo? - Inclui dizendo
   que o intuito foi demonstrar os passos da abordagem paramétrica e não
   comparar os modelos. Mas que outras distribuições poderiam ser mais
   apropriados para estes dados (informação antes de iniciar a
   demonstração da não paramétrica)
