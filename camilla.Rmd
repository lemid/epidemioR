...
a ocorrência de um evento é a variável de interesse. Por exemplo, o tempo para
a ocorrência de sintomas de uma doença e/ou o tempo para aparecimento dos sinais do patógeno, respectivamente, o
período de incubação e período de latência, são componentes do
monociclo e estudos são de grande importância para o entendimento das epidemias.
...
ocorrência de um eento. Fonte: os autores.
