...
Podridões em frutos levam a redução de produtividade, visto que frutos doentes não são comercializados. Componentes do monociclo da doença podem ser investigados em diferentes estágios de crescimento de frutos para direcionar aplicações de produtos na época de maior suscetibilidade. Desta forma, o objetivo deste estudo de caso foi estimar e comparar o período de incubação de uma podridão em macieira em cinco estágios de crescimento de frutos. 
O experimento foi realizado em condições controladas, utilizando frutos destacados. Cinco tamanhos de frutos foram coletados do campo (tam1, tam2, tam3, tam4 e tam5). 
Os frutos foram desinfestados e um ferimento foi provocado
...
knitr::include_graphics("camilla/tamanhos.jpg")
```

Após a inoculação, cada fruto foi avaliado diariamente durante 39
dias devido ao apodrecimento dos frutos após este período. O dia do aparecimento de sintomas foi anotado e atribuido o status
...
leitura, fez o gráfico que exibe a data e o tipo de evento de cada
...
que metade dos indivíduos expostos apresentem o evento. Portanto, o
...
estimador não paramétrico da curva de sobrevivência.- eu coloquei a referencia na introdução. Aqui também é necessario dai?
:::
...
prorporção de censura for baixa. A censura pode ser mitigada aumentando o
tempo de avaliação do experimento para que se observe o evento em mais
...
por meio da estimativa do parâmetro de locação. A dsitribuição utilizada foi a de Weibull apenas com o intuito de ilustrar os passos para a técnica. Porém, esta pode não ser a distribuição mais adequada para estes dados.
...
que ele ocorreu do dia 9 para o dia 10, certo? Sim
:::
 ...
 * Comentar que a Weibull pode não ser o melhor modelo? - Inclui  dizendo que o intuito foi demonstrar os passos da abordagem paramétrica e não comparar os modelos. Mas que outras distribuições poderiam ser mais apropriados para estes dados (informação antes de iniciar a demonstração da não paramétrica)
