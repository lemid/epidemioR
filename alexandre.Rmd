...
tb_params <- as.data.frame(sapply(tb_params, as.numeric))

tb_params <- tb_params %>% 
  mutate_if(is.numeric, round, digits = 2)

tb_params$trat <- levels(tb$trat)
...
### Comparando as estimativas de EC50 com o nlme, o drc e o log das concentrações
...
knitr::include_graphics("./alexandre/curvaexemplo.jpg")
```
