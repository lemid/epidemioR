...
monociclo extensamente estudados para o entendimento de epidemias. Do
ponto de vista de análise de dados, são variáveis de duração ou tempo
até o evento.
...
apresentava sintomas da doença antes do início da contagem do tempo
para o evento. O último é a censura intervalar em que o evento ocorre
entre duas avaliações consecutivas, comum em sistemas de avaliação onde
observa-se pelo desfecho a cada 24 horas, ou 12 horas, por exemplo.
...
knitr::include_graphics("./101-camilla/censuras.png")
```
...
resultado. No caso da análise de experimentos com variável resposta
tempo até o evento, a análise de variância variância pode não ser
apropriada pois, a censura é desconsiderada. Descartar os dados
censurados faz com que o risco/tempo estimado para a ocorrência de um
evento seja viciado e compromete o poder dos testes, pois ocorre redução
do tamanho da amostra. Considerar o dado censurado como exato, por sua
vez, gera vícios na estimação. Por último, até mesmo quando não se tem
censuras, dados de tempo até o evento geralmente tem distribuições
assimétricas, e assim, não apresentam distribuição normal.
...
O log-Rank testa a hipótese nula de que as curvas de
...
knitr::include_graphics("101-camilla/curvaskaplan.jpg")
```
