# Análise de sobrevivência em esquema fatorial relacionando diferentes espécies com eficiência de fungicidas para controle de doença 

Introducao das doencas!!

O modelo paramétrico de Weibull...


Na sequencia, os passo para a analise de sobrevivencia no software R studio...
...
Para as análises das eficiências de controle dos fungicidas considerando o tempo para ocorrência dos primeiros sintomas e sinais em frutos destacados inoculados com diferentes espécies de *Colletotrichum* serão avaliadas por intermédio da análise de sobrevivência...
