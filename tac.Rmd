...
Baseado nos ensaios *in vitro*, isolados serão classificados fenotipicamente (baixo, médio ou alto valores de EC~50~) em relação a sensibilidade aos fungicidas, e alguns isolados representativos são selecionados para realização de ensaios ensaios *ex vivo*. Estes testes podem ser realizados com plantas (ensaios in vivo) ou partes vegetais destacadas (ensaios ex vivo), que serão submetidos a um tratamento com a concentração recomendada para o produtor [@Schnabel2015] . 

Estes experimentos são recomendados para verificar uma possível resistência prática de um fungicida no controle de um patógeno/doença. Resistencia prática portanto, está relacionada a uma possível falha do controle da doença em campo [@ghinirekimatih2000]  É esperado que isolados com alto (ou até médio) valor de EC~50~ são capazes de desenvolver doença em frutos tratados com fungicidas, assim como nos frutos controle (testemunha).
...
(ref:prancha-1) Esquema ilustrativo do ensaio de eficiência de fungicidas (ESCREVER MELHOR A LEGENDA). 
...
# Fazendo o estudo da interação com desdobramento testes para o
