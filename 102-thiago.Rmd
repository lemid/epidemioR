# Análise de sobrevivência por abordagem paramétrica com experimento fatorial
...
doenças de plantas, porém alguns fungicidas de sítios específicos
...
Neste uso de análise de sobrevivência, o objetivo proposto foi avaliar
...
combinando por completo seis fungicidas (A, B, C, D, E e testemunha) com
...
experimentais de uma combinação experimental (13 frutos) apresentaram o
...
A análise com a abordagem paramétrica é interessante pois, além de ser
apropriada para o tipo de variável resposta em questão, é capaz de
acomodar a estrutura experimental.
