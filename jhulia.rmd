...
## Germinação de conídios
  ...
  O experimento de germinação de conídios de *N. ditissima* com suspensão de 10^5^ conídios . mL^-1^. A suspensão foi então espalhada em placas de petri contendo AA e estas foram incubadas sob diferentes temperaturas e períodos de incubação com umidade constante em câmaras BOD. As temperaturas foram de 12, 14, 16, 18, 20, 22, 26, 28, 35 °C, em períodos de incubação de 3, 6, 12, 24, 36, 48, 60 horas.
